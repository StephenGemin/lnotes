...
int main(int argc, char **argv) {
    ...
    if (strcmp(cmd, "rm") == 0 ||
        strcmp(cmd, "remove") == 0)                   return cmd_remove(sub_argc, sub_argv);
    if (strcmp(cmd, "ls") == 0 ||
        strcmp(cmd, "list") == 0)                     return cmd_list(sub_argc, sub_argv);
    if (strcmp(cmd, "search") == 0)                   return cmd_search(sub_argc, sub_argv);
